...
<html lang="es">
    ...
    <body>
        ...
        <div class="barra-buscar col-md-12">
            <input id='input_bc' type="text" class="txt-buscar" placeholder="BUSCAR POR TITULO/AUTOR">
            <button class="btn-BC">BUSCAR</button>
            <button class="btn-CC" ><span style="font-size: 22px;color: black;" class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> CARRITO DE COMPRAS</button>
        </div>
        <div>
            espacio para el baner
        </div>
        <div class="container">
            <div class="row">
                <h2 align="center">NOVEDADES</h2>
                <div class="col-md-3">
                    <img src="../images/spiderman3.jpg">
                </div>
                <div class="col-md-3">
                    <img src="../images/spiderman3.jpg">
                </div>
