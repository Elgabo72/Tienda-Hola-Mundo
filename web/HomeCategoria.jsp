            ...
            <div class="col-md-12" id="FondoListaCategoria">
                <div class="d-flex">
                    <div class="col-sm-4">
                        ...
                        <br>
                        <div class="form-boby">
                            <form action="Controlador?menu=HomeCategoria" method="POST">
                                <div class="form-group">
                                    <label style="text-align: left">Categoria</label>
                                    <input type="text" value="${categoria.getNomcat()}" name="txtnombre" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Descripcion</label>
                                    <input type="text" value="${categoria.getDescat()}" name="txtdescripcion" class="form-control">
                                </div> 
                            ...
                            <tbody>
                                <c:forEach var="ca" items="${categorias}">
                                    <tr>
                                        ...
                                        <td>${ca.getDescat()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="Controlador?menu=HomeCategoria&accion=Editar&id=${ca.getId()}">Editar</a>
                                            <a class="btn btn-danger" href="Controlador?menu=HomeCategoria&accion=Delete&id=${ca.getId()}">Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
